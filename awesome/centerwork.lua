...
local function arrange(p, layout)
  ...
  -- Hack to float all clients after the first 3 to give me 3 equally sized
  -- columns, and after that every client is opened center screen with half the
  -- height and 400px less width of the master
